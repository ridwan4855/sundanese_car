...
export const About = () => {
  return (
    <Element
      name="About Us"
      className="relative bg-gradient-to-b from-[#ffffff] via-[#f0f4f8] to-[#e0e0e0]"
    >
      <div className="overflow-hidden relative h-full w-full pt-[100px] pb-[100px]">
      ...
      <div className="absolute top-0 right-0 h-full z-40 pointer-events-none">
        <div className="relative h-full flex justify-center items-center pointer-events-auto">
          <div className="sticky bottom-6 right-6 rounded-full bg-[rgb(255,255,255)] flex self-end m-3 p-3 z-30 space-x-3 shadow-xl hover:scale-110 transition-transform duration-300 pointer-events-none">
            <div
              className="w-[50px] h-[50px] rounded-full overflow-hidden flex items-center justify-center relative 
